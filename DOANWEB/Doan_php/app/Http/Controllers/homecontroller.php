...

{
    ...
    {
        $sach1 = product::where('category_id',1)->orderBy('id','DESC')->get();
        $sach2 = product::where('category_id',2)->orderBy('id','DESC')->get();
        $sach3 = product::where('category_id',3)->orderBy('id','DESC')->get();
