      ...
      <div>
        <ul id="header">
          ...
          <li id="down1">
            ...
            <ul id="dc1">
              <li>
                <Link to="/category/sominu">Sách</Link>
              </li>
              <li>
                <Link to="/category/chanvay">sách</Link>
              </li>
              <li>
                <Link to="/category/vaydamcongso">sách</Link>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li id="down2">
            ...
            <ul id="dc2">
              <li>
                <Link to="/category/bosuutapmoi">Bộ sưu tập</Link>
              </li>
              <li>
                <Link to="/category/somichanvay">Sách</Link>
              </li>
              <li>
                <Link to="/category/sandouudai">Sách</Link>
              </li>
              <li>
            ...
            <>
              ...
              <li>
                <button
                  ...
                  style={{ with: 150, height: 42, fontSize: 12, float: "left" }}
                >
                  {" "}
