    ...
    <div>
        ...
        <div>
          <ul id="header">
            ...
            <li id="down1">
              ...
              <ul id="dc1">
                <li>
                  <Link to="/category/sominu">Sách giáo khoa</Link>
                </li>
                <li>
                  <Link to="/category/chanvay">Sách kinh tế</Link>
                </li>
                <li>
                  <Link to="/category/vaydamcongso">Truyện tranh</Link>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li id="down2">
              ...
              <ul id="dc2">
                <li>
                  <Link to="/category/bosuutapmoi">Truyện tranh</Link>
                </li>
                <li>
                  <Link to="/category/somichanvay">Sách giáo khoa</Link>
                </li>
                <li>
                  <Link to="/category/sandouudai">Triết học</Link>
                </li>
                <li>
                  <Link to="/category/xahang">Văn học hiện đại</Link>
                </li>
              </ul>
            </li>
            <li>
      ...
      <div>
        <img
          id="anhheader"
          className="img-fluid"
          src="https://cdn.pancake.vn/1/s2440x2440/fwebp/05/1c/2a/18/34163fb540f64d10cdae34765a98a85746917f44b0e10a5b3e97ecdc.png"
        ...
        <div className="nd">
          <div className="nd1">
            ...
            <div className="chi">
              ...
              <p>
                Miễn phí vận chuyển toàn quốc với đơn hàng giá trị trên 599K
              </p>
            </div>
          </div>
          ...
          <div className="nd1">
            ...
            <div className="chi">
              ...
              <p>
                Áp dụng theo chính sách đổi trả hàng của thời trang Citi Mode
              </p>
            </div>
          </div>
          ...
          <div className="nd1">
            ...
            <div className="chi">
              ...
              <p>
                Citi Mode cam kết bảo mật 100% với thông tin thanh toán của
                khách hàng
              </p>
            </div>
          </div>
          ...
          {vaydamcs.map((vdcs) => {
            return (
              <div className="vay1" key={vdcs.id}>
                ...
                <p className="ahoandz">
                  <Link to={`/Detail/${vdcs.title}/${vdcs.id}`}>
                    {vdcs.title}
                  </Link>
                </p>
                <br></br>
          ...
          {sominu.map((sominu) => {
            return (
              <div className="vay1" key={sominu.id}>
                ...
                <p className="ahoandz">
                  <Link to={`/Detail/${sominu.title}/${sominu.id}`}>
                    {sominu.title}
                  </Link>
                </p>
                <br></br>
          ...
          {chanvay.map((chanvay) => {
            return (
              <div className="vay1" key={chanvay.id}>
                ...
                />
                <p className="ahoandz">
                  <Link to={`/Detail/${chanvay.title}/${chanvay.id}`}>
                    {chanvay.title}
                  </Link>
                </p>
                <br></br>
          ...
          <div class="container">
            <div class="blkh">
              <div class="hand">
                ...
                />
                <p>
                  Tiền nào của nấy, rất ngại mua đồ chợ, mua sản phẩm của Citi
                  Mode rồi thấy rất ưng và yên tâm!
                </p>
              ...
              <div class="hand">
                ...
                />
                <p>
                  Citi Mode giao hàng rất nhanh mà đảm bảo. Hãng uy tín, mình
                  mua nhiều lần rồi nên rất yên tâm chuyển khoản trước!
                </p>
              ...
              <div class="hand">
                ...
                />
                <p>
                  Mặc đầm của Citi Mode rất hợp, có bộ sưu tập mới ra là lại sốt
                  xình sịch!
                </p>
            ...
            <div className="slidechung">
              <div className="slidecc">
                ...
                >
                  ...
                  <p className="yasuo">
                    Đừng mãi chỉ chạy theo xu hướng, hiểu rõ cơ thể mình mới là
                    điều quan trọng nhất để mặc đẹp mỗi ngày. Hy vọng những chia
                    sẻ của Citi Mode sẽ phần nàng tự tin hơn trong khoảng lựa
                    chọn trang phục để luôn tỏa sáng nhất nàng nhé.
                  </p>
                  <h6>
                    <Link to="/hrctddhmn">
                      {" "}
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <p className="yasuo">
                    ...
                    trung hay những kiểu dáng bodycon ấn tượng cho vẻ ngoài cuốn
                    hút thì những thiết kế đầm xòe lại không làm cho các Quý cô
                    thất vọng với sự nhẹ nhàng và vô cùng nữ tính.
                  </p>
                  <h6>
                    <Link to="/nbvanvddx">
                      {" "}
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <BsFillPersonFill /> Thời trang hot
                  <p className="yasuo">
                    Chân váy bút chì là 1 trong những item kinh điển của phụ nữ
                    công sở. Item này vừa đơn giản, tôn dáng lại mang cảm giác
                    thanh lịch, chỉn chu cho người mặc. Phụ nữ Hàn cũng thường
                    xuyên chọn diện chân váy bút chì khi đến sở làm. Thậm chí,
                    họ còn biến tấu, mix&match chân váy bút chì với nhiều item
                    khác biệt để có được những bộ cánh mới mẻ mỗi ngày.
                  </p>
                  <h6>
                    <Link to="/cdcvbc">
                      {" "}
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <BsFillPersonFill /> Thời trang hot
                  <p className="yasuo">
                    Kể từ thời cổ đại, màu đỏ đại diện cho cuộc sống sung túc,
                    cho nguồn sức mạnh dồi dào và niềm đam mê cháy bỏng. Trong
                    thời trang, không ít những món đồ màu đỏ đã trở thành biểu
                    tượng thương hiệu riêng cũng như đại diện thương hiệu chung.
                    Trang phục màu đỏ có sức mê hoặc khó cưỡng, tạo hiệu ứng thị
                    giác mạnh mẽ, là cách các nàng thể hiện bản lĩnh tự tin và
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <h5>
                    <Link to="/cctpsm">
                      {" "}
                      Các công thức phối sơ mi + chân váy cả tuần cho nàng công
                      sở
                    </Link>{" "}
                  </h5>
                  <BsFillPersonFill /> Thời trang hot
                  <p className="yasuo">
                    Trong trường hợp quá lười chọn đồ hoặc bí ý tưởng, nàng cứ
                    diện một set đồ an toàn mà chuẩn nhất cho chốn công sở,
                    chính là nguyên set đồ vest. Áo vest đi cùng chân váy luôn
                    là outfit đạt điểm 10 về độ lịch sự, mang đậm hơi thở quý cô
                    công sở và gần như không có điểm trừ. Outfit này chỉ có đôi
                    chút bất tiện nếu diện trong thời tiết nóng bức. Bởi vì thế
                    nàng hãy ưu tiên chọn set đồ này cho những ngày khí hậu mát
                    mẻ, đặc biệt trong những ngày có sự kiện quan trọng như họp
                    hành, gặp mặt khách hàng để đảm bảo nét thanh lịch, kín đáo
                    cho chính mình nàng nha!
                  </p>
                  <h6>
                    <Link to="/cctpsm">
                      {" "}
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <BsFillPersonFill /> Thời trang hot
                  <p className="yasuo">
                    Thời trang không chỉ là lĩnh vực liên quan đến phạm trù thẩm
                    mỹ mà ở trong đó còn ẩn chứa những bí mật hết sức thú vị. Có
                    thể nàng chưa biết, mỗi màu sắc trong thời trang đều nói lên
                    một tính cách ẩn sâu trong con người nàng. Và dưới đây là ý
                    nghĩa màu sắc thời trang và cách phối màu quần áo phù hợp
                    cho mỗi ngày đi làm nàng nha!
                  </p>
                  <h6>
                    <Link to="/dlmj">
                      {" "}
              ...
              <div className="slidecc">
                ...
                >
                  ...
                  <BsFillPersonFill /> Thời trang hot
                  <p className="yasuo">
                    Không xa hoa lộng lẫy, không cần quá nổi bật giữa đám đông,
                    những mẫu đầm hàng hiệu luôn sở hữu vẻ đẹp lung linh đến
                    diệu kỳ, khiến chị em không thể nào rời mắt.{" "}
                  </p>
                  <h6>
                    <Link to="/vdcscc">
                      {" "}
